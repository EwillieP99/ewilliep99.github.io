...
export function EchoOrb({ onClick, isClean }: EchoOrbProps) {
  return (
    <motion.button
      onClick={onClick}
      className={`fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-[9999] w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center border-4 hover:scale-110 active:scale-95 transition-all ${
        isClean
