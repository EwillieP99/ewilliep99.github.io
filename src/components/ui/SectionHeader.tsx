...
export function SectionHeader({ label, sub, codename }: SectionHeaderProps) {
  return (
    <div className="section-label">
      <div>
        {codename && (
          <p className="text-xs font-mono text-neon-cyan/60 tracking-[0.2em] uppercase mb-1">
            {codename}
          </p>
        )}
        <h2 className="text-2xl sm:text-3xl font-bold text-slate-100 tracking-tight font-display">
          {label}
        </h2>
        {sub && (
